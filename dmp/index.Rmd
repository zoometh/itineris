...
kable(example1.ITA.t, "html",
  ...
  kable_styling(full_width = FALSE,
                ...
                font_size=12)
```
Pour les besoins de la sérialisation, certains noms de champs sont retranscris en anglais en nous servant de la table de correspondances linguistique (voir \ref{lexicon}).
...
# colnames(example1.t)[1] <- "valeurs"
kable(example1.ENG.t, "html",
      # row.names = F,
      caption = "Analyses élémentaires, exemple 1, traduit en anglais") %>%
  kable_styling(full_width = FALSE,
                position = "center",
                font_size=12)
```
