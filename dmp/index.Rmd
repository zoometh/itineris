...
df.info <- data.frame("Acronyme" = "Itineris",
                      "Code décision" = "XXXX",
                      "Titre" = "XXXX",
                      "Coordinateur" = "Veronica Ciccolani",
                      "Affiliation" = "AOROC",
...
## Collecte et réutilisation des données {#wp3.step.collec}
...
tools.res$output <- str_replace(tools.res$output, ".shp", "[.txt](#Fshp)")
...
<center>[https://github.com/zoometh/itineris/tree/main/data](https://github.com/zoometh/itineris/tree/main/data)</center>
